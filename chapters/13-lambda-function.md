...
В імперативних мовах між функціями і даними проведена чітка межа: ось це функції, а ось це &mdash; дані. Проте в Haskell між даними і функціями різниці немає, адже і те й інше спочиває на одній і тій же Черепасі. Ось тип функції `mul`:
...
Тепер вирази `containsAtSign` і `endsWithCom` прирівняні до ЛФ від одного аргументу. У цьому випадку ми звичайно ж не вказуємо тип цих виразів. Втім, якщо дуже хочеться, можна вказати, наприклад:
...
Втім, на практиці вказівка типу ЛФ зустрічається вкрай рідко, бо не є потрібною.
